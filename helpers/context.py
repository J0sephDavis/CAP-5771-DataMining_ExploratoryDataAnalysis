...
class EnvFields(_StrEnum):
	...
	DIR_GENERATED_DATASETS='DIR_GENERATED_DATASETS'
	...
	DIR_FIGURES_ANIME_CLEAN_OUT='DIR_FIGURES_ANIME_CLEAN_OUT'
	...
	RANKING_FILTERED_PRE='RANKING_FILTERED_PRE'
	RANKING_FILTERED_PRE_OUT='RANKING_FILTERED_PRE_OUT'
	
	RANKING_FILTERED='RANKING_FILTERED'
	RANKING_FILTERED_OUT='RANKING_FILTERED_OUT'
	RANKING_CLEANED='RANKING_CLEANED'
	RANKING_CLEANED_OUT='RANKING_CLEANED_OUT'
